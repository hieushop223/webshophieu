        ...
        >
          ...
          <div className="mt-4 flex flex-col items-center gap-4 text-center">
            ...
            <div className="flex gap-6 mt-2">
              {/* ZALO */}
              <a
                href="https://zalo.me/g/cumffz847"
                target="_blank"
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/Ilovebapgi/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg border border-white/30 text-blue-400 hover:text-blue-300 font-bold transition-all"
              >
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@emfat_pxt?lang=vi-VN"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg border border-white/30 text-white hover:text-gray-300 font-bold transition-all"
              >
                <div className="bg-white/20 p-1 rounded">
